...
public class MeepMeepTestingBlueGate_Version3 {
    public static void main(String[] args) {
        ...
        double newShootX = -25, newShootY = -25; // -22, 22
        ...
        Pose2d classifierPose = new Pose2d(7.5, -64, Math.toRadians(240));
...
//                .splineToSplineHeading(new Pose2d(12.4, 43, Math.toRadians(92)), Math.toRadians(90))
                        ...
                        .splineToLinearHeading(new Pose2d(0, -31, Math.toRadians(-120)), Math.toRadians(135)) //200
...
//                        .setTangent(Math.toRadians(-15))
                        ...
                        .setTangent(Math.toRadians(10)) //15
