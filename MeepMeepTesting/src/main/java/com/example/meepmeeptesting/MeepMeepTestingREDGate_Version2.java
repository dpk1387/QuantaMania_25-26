...
public class MeepMeepTestingREDGate_Version2 {
    public static void main(String[] args) {
        ...
        Pose2d classifierPose = new Pose2d(7.7, 64, Math.toRadians(114));
...
//                        .splineToSplineHeading(new Pose2d(11.5, 51, Math.toRadians(92)), Math.toRadians(95))
...
//                        .splineToSplineHeading(new Pose2d(0, 30, Math.toRadians(135)), Math.toRadians(-132))
                        ...
                        //.setTangent(Math.toRadians(25)) //15
//                        .splineToSplineHeading(new Pose2d(0, 32, Math.toRadians(135)), Math.toRadians(40))
                        .splineToLinearHeading(classifierPose, Math.toRadians(95)) //85 //95 //go into
                        .waitSeconds(1.5)
