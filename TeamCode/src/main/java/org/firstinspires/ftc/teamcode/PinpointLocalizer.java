...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -3276.255234091184;//0.0; // y position of the parallel encoder (in tick units)
        public double perpXTicks =  -3371.7833709780334;//0.0; // x position of the perpendicular encoder (in tick units)
    }
...
//        driver.setOffsets(mmPerTick * PARAMS.parYTicks, mmPerTick * PARAMS.perpXTicks, DistanceUnit.MM);
        ...
        driver.setOffsets(180.0, -160.0, DistanceUnit.MM);
        // Use goBILDA 4-bar odometry pod preset for ticks-per-mm
