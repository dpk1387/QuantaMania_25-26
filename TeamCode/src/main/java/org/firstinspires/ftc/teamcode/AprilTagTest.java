...
public class AprilTagTest extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        AprilTagLibrary tagLibrary = new AprilTagLibrary.Builder()
                /*.addTag(0, "Tag0", tagSize, DistanceUnit.INCH)
                .addTag(1, "Tag1", tagSize, DistanceUnit.INCH)
                .addTag(2, "Tag2", tagSize, DistanceUnit.INCH)
                .addTag(3, "Tag3", tagSize, DistanceUnit.INCH)
                .addTag(4, "Tag4", tagSize, DistanceUnit.INCH)
                .addTag(5, "Tag5", tagSize, DistanceUnit.INCH)*/
