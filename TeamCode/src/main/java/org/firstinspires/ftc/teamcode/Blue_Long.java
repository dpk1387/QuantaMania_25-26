...
public class Blue_Long extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            SHOOT(); // shoot preloads
            driver.turn(-60, 1000);
            driver.drive(0, 24, 0, 2000); // get into position to collect artifacts
            driver.drive(40, 0, 0, 2000); //collect artifacts
            sleep(100);
            driver.drive(-40, -24, 0, 3000);
            driver.turn(60, 1000);
            SHOOT();
        }
